#Intial Database and flask setup w/keys
import numpy as np
...
def welcome():
    return (
        ...
        f"Temp one year: /api/v1.0/tobs<br/>"
        f"Temp from the start date(yyyy-mm-dd): /api/v1.0/yyyy-mm-dd<br/>"
        f"Temprom start to end date(yyyy-mm-dd): /api/v1.0/yyyy-mm-dd/yyyy-mm-dd"
    )
#Api 
